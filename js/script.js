...
const I18N = {
  ...
  en: {
    ...
    footer_hours_html: 'Check-in: 2 PM &nbsp;|&nbsp; Check-out: 12 PM',
  ...
  es: {
    ...
    footer_hours_html: 'Entrada: 14h &nbsp;|&nbsp; Salida: 12h',
...
function initBookingButtons() {
  ...
  // "Reserve Já" — leva direto para a página do hotel no Omnibees
  document.querySelectorAll('.btn-reserve, [data-reserva]').forEach(el => {
      ...
      <article class="acc-card reveal" data-id="${a.id}">
        ...
        <div class="acc-body">
          ...
          <div class="acc-actions">
            <button class="btn btn-primary" onclick="showToast('⚠️ Sistema de reservas em desenvolvimento!')" data-i18n="reservaragora">Reservar Agora</button>
          </div>
        </div>
      </article>
